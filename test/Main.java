...
public class Main {
    ...
    private static void testDatabaseOperations(DatabaseManager dbManager) {
        ...
        Product testProduct1 = new Product("Laptop", 2.5, 1000, category1.getId());
        Product testProduct2 = new Product("Banana", 0.15, 1.5, category2.getId());
        ...
        if (retrievedProduct != null) {
            System.out.println("Product retrieved by its id: " + retrievedProduct.getName() + " with price:"
                    + retrievedProduct.getPricePerKg());
        }
